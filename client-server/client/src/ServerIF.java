...
public interface ServerIF extends Remote {
    ...
    String makeReservation(String studentId, String courseId) throws RemoteException;
    ...
    String login(String id, String password) throws RemoteException;
    void registerPassword(String id, String password) throws RemoteException;
